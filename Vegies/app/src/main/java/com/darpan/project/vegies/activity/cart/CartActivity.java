package com.darpan.project.vegies.activity.cart;
...
import com.darpan.project.vegies.adapters.category.Cart.CartAdapter;
        ...
        productViewModal.getAllCartData().observe(this, new Observer<List<ProductTable>>() {
            ...
            public void onChanged(List<ProductTable> productTables) {
                ...
                if (productTables.size() == 0) {
                    ...
                    /*setting up the cart data*/
                    cartAdapter = new CartAdapter(productTables
                            , CartActivity.this);
