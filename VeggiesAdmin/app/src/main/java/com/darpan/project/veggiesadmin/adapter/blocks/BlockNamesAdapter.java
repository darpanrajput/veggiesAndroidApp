...
import com.darpan.project.veggiesadmin.adapter.areaBlock.AreaBlockAdapter;
...
public class BlockNamesAdapter
        extends FirestorePagingAdapter<BlockName,BlockNamesAdapter.NameHolder> {

    private OnItemClick listener;
    private OnLoadingStateChanged onLoadingStateChanged;
    public BlockNamesAdapter(@NonNull FirestorePagingOptions<BlockName> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull NameHolder holder, int position, @NonNull BlockName model) {
