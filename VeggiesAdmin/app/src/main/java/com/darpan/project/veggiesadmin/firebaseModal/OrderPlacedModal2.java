...
public class OrderPlacedModal2 implements Parcelable{
    /*all are strings*/
    @Exclude
    ...
    public OrderPlacedModal2() {
    }

    public OrderPlacedModal2(List<String> UniquePid,
    ...
    protected OrderPlacedModal2(Parcel in) {
    ...
    public static final Creator<OrderPlacedModal2> CREATOR = new Creator<OrderPlacedModal2>() {
        @Override
        public OrderPlacedModal2 createFromParcel(Parcel in) {
            return new OrderPlacedModal2(in);
        }

        @Override
        public OrderPlacedModal2[] newArray(int size) {
            return new OrderPlacedModal2[size];
        }
    };
